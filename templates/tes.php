...
<script src="../scripts/simulation_functions.js"></script>
<body>
    <div id="wrapper">
        <div id="headerwrap">
        <div id="header">
        ...
        <div id="navigation">
            <div id="controles">
                ...
                <button class="model-control" type="button" onclick="resetPressed    ()"><img src="flexsimweb/images/_reset.png"/> Resetar</button>
                <button class="model-control" type="button" onclick="runPressed      ()"><img src="flexsimweb/images/_go.png"/> Rodar</button>
                <button class="model-control" type="button" onclick="stopPressed     ()"><img src="flexsimweb/images/_stop.png"/> Parar</button>
                <button class="model-control" type="button" onclick="stepPressed     ()"><img src="flexsimweb/images/_step.png"/> Avançar</button>
                </div>
                <div id="simRunTime">
                    Tempo de execução:
        ...
        <div id="contentwrap">
        <div id="content">
            <video width="917" height="498" controls="controls" autoplay="autoplay">
            <source src="../video/teste_ogg.ogg" type="video/ogg">
            <object data="" width="320" height="240">
            <embed width="900" height="470" src="../video/teste_ogg.ogg">
            </object>
            </video>
        </div>
        </div>
